...
root.title("Upload Bulk NFTs  to OpenSea  ")
...
upload_folder_input_button = tkinter.Button(root, width=20, text="Add the NFTs Upload Folder", command=upload_folder_input)
